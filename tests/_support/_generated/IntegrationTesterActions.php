<?php  //[STAMP] 6ccc1df6ba8a5a32ba82390d6aaa4dd4
...
trait IntegrationTesterActions
{
    ...
    public function seeInMemcached($key, $value = NULL) {
        return $this->getScenario()->runStep(new \Codeception\Step\Assertion('seeInMemcached', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
    ...
    public function canSeeInMemcached($key, $value = NULL) {
        return $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('seeInMemcached', func_get_args()));
    }
    ...
    public function dontSeeInMemcached($key, $value = NULL) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('dontSeeInMemcached', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
    ...
    public function cantSeeInMemcached($key, $value = NULL) {
        return $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('dontSeeInMemcached', func_get_args()));
    }
    ...
    public function haveInMemcached($key, $value, $expiration = NULL) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('haveInMemcached', func_get_args()));
    }
    ...
    public function clearMemcache() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('clearMemcache', func_get_args()));
    }
     ...
     * @see \Codeception\Module\Redis::dontSeeInRedis()
     */
    public function cantSeeInRedis(string $key, $value = NULL): void {
     ...
     * @see \Codeception\Module\Redis::dontSeeRedisKeyContains()
     */
    public function cantSeeRedisKeyContains(string $key, $item, $itemValue = NULL): void {
     ...
     * @see \Codeception\Module\Redis::seeInRedis()
     */
    public function canSeeInRedis(string $key, $value = NULL): void {
     ...
     * @see \Codeception\Module\Redis::seeRedisKeyContains()
     */
    public function canSeeRedisKeyContains(string $key, $item, $itemValue = NULL): void {
     ...
     *
     * @return string
     * @see \Helper\Unit::convertDirSeparator()
     */
    public function convertDirSeparator(string $input): string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('convertDirSeparator', func_get_args()));
    }
