<?php  //[STAMP] d0eb5848e56015168bc87055a4566e85
...
trait UnitTesterActions
{
    ...
    public function seeInApc($key, $value = NULL) {
        return $this->getScenario()->runStep(new \Codeception\Step\Assertion('seeInApc', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     ...
     * @see \Codeception\Module\Apc::seeInApc()
     */
    public function canSeeInApc($key, $value = NULL) {
        return $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('seeInApc', func_get_args()));
    }
    ...
    public function dontSeeInApc($key, $value = NULL) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('dontSeeInApc', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     ...
     * @see \Codeception\Module\Apc::dontSeeInApc()
     */
    public function cantSeeInApc($key, $value = NULL) {
        return $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('dontSeeInApc', func_get_args()));
    }
    ...
    public function flushApc() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('flushApc', func_get_args()));
    }
