 ...
 * @todo    : refactor
 */
final class DispatcherAfterDispatchTest extends BaseDispatcher
{
    /**
     ...
     * @since  2017-10-07
     */
    public function testAfterDispatchForwardOnce(): void
    {
        $forwarded  = false;
     ...
     * @since  2017-10-07
     */
    public function testAfterDispatchReturnFalse(): void
    {
        $dispatcher         = $this->getDispatcher();
     ...
     * @since  2017-10-07
     */
    public function testAfterDispatchWithBeforeExceptionBubble(): void
    {
        $dispatcher         = $this->getDispatcher();
        $dispatcherListener = $this->getDispatcherListener();
     ...
     * @since  2017-10-07
     */
    public function testAfterDispatchWithBeforeExceptionForwardOnce(): void
    {
        $forwarded          = false;
        $dispatcher         = $this->getDispatcher();
        $dispatcherListener = $this->getDispatcherListener();
     ...
     * @since  2017-10-07
     */
    public function testAfterDispatchWithBeforeExceptionReturningFalse(): void
    {
        $dispatcher = $this->getDispatcher();
