...
namespace Phalcon\Tests\Unit\Html\Tag\Form;
 ...
 *
 * @package Phalcon\Tests\Unit\Html\Tag\Form
 */
class UnderscoreInvokeCest
{
    /**
     * Tests Phalcon\Html\Tag\Form :: __invoke()
     *
    ...
    {
        $I->wantToTest('Html\Tag\Form - __invoke()');
        $escaper = new Escaper();
