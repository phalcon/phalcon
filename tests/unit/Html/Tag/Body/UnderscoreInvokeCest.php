...
namespace Phalcon\Tests\Unit\Html\Tag\Body;
 ...
 *
 * @package Phalcon\Tests\Unit\Html\Tag\Body
 */
class UnderscoreInvokeCest
{
    /**
     * Tests Phalcon\Html\Tag\Body :: __invoke()
     *
    ...
    {
        $I->wantToTest('Html\Tag\Body - __invoke()');
        $escaper = new Escaper();
