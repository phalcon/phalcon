...
namespace Phalcon\Tests\Unit\Html\Tag\Button;
 ...
 *
 * @package Phalcon\Tests\Unit\Html\Tag\Button
 */
class UnderscoreInvokeCest
{
    /**
     * Tests Phalcon\Html\Tag\Button :: __invoke()
     *
    ...
    {
        $I->wantToTest('Html\Tag\Button - __invoke()');
        $escaper = new Escaper();
