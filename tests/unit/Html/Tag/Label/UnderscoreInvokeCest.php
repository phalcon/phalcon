...
namespace Phalcon\Tests\Unit\Html\Tag\Label;
 ...
 *
 * @package Phalcon\Tests\Unit\Html\Tag\Label
 */
class UnderscoreInvokeCest
{
    /**
     * Tests Phalcon\Html\Tag\Label :: __invoke()
     *
    ...
    {
        $I->wantToTest('Html\Tag\Label - __invoke()');
        $escaper = new Escaper();
