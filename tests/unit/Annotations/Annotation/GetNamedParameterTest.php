...
final class GetNamedParameterTest extends UnitTestCase
{
    ...
    public function testAnnotationsAnnotationGetNamedParameter(): void
    {
        ...
        $this->assertSame($annotation->getNamedParameter($exprName), $result);

        $result1 = [
            $name2 => $value2,
        ];

        $this->assertSame($annotation->getNamedParameter($exprName1), $result1);
    }
}
