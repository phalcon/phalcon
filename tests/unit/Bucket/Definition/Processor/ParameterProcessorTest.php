...
use Phalcon\Bucket\Definition\Processor\ParameterProcessor;
...
final class ParameterProcessorTest extends AbstractUnitTestCase
{
     ...
     * @since  2026-04-18
     */
    public function testBucketDefinitionProcessorParameterProcessorCanProcessAlwaysReturnsTrue(): void
    {
     ...
     * @since  2026-04-18
     */
    public function testBucketDefinitionProcessorParameterProcessorProcessClosureIsNotCacheable(): void
    {
        $processor = new ParameterProcessor();
     ...
     * @since  2026-04-18
     */
    public function testBucketDefinitionProcessorParameterProcessorProcessObjectIsNotCacheable(): void
    {
        $processor = new ParameterProcessor();
     ...
     * @since  2026-04-18
     */
    public function testBucketDefinitionProcessorParameterProcessorProcessReturnsCorrectType(): void
    {
        $processor = new ParameterProcessor();
     ...
     * @since  2026-04-18
     */
    public function testBucketDefinitionProcessorParameterProcessorProcessScalarIsCacheable(): void
    {
        $processor = new ParameterProcessor();
     ...
     * @since  2026-04-18
     */
    public function testBucketDefinitionProcessorParameterProcessorProcessSetsServiceName(): void
    {
        $processor = new ParameterProcessor();
