...
use Phalcon\Bucket\Definition\Processor\ClosureProcessor;
...
final class ClosureProcessorTest extends AbstractUnitTestCase
{
     ...
     * @since  2026-04-18
     */
    public function testBucketDefinitionProcessorClosureProcessorCanProcessReturnsFalseForNonClosure(): void
    {
     ...
     * @since  2026-04-18
     */
    public function testBucketDefinitionProcessorClosureProcessorCanProcessReturnsTrueForClosure(): void
    {
        $processor = new ClosureProcessor();
     ...
     * @since  2026-04-18
     */
    public function testBucketDefinitionProcessorClosureProcessorProcessReturnsCorrectType(): void
    {
        $processor = new ClosureProcessor();
        $closure   = static function () {
            return new stdClass();
     ...
     * @since  2026-04-18
     */
    public function testBucketDefinitionProcessorClosureProcessorProcessSetsFactory(): void
    {
        $processor = new ClosureProcessor();
        $closure   = static function () {
            return new stdClass();
     ...
     * @since  2026-04-18
     */
    public function testBucketDefinitionProcessorClosureProcessorProcessSetsServiceName(): void
    {
        $processor = new ClosureProcessor();
        $closure   = static function () {
            return new stdClass();
