...
final class CallTest extends AbstractUnitTestCase
{
     ...
     * @since  2026-04-18
     */
    public function testBucketResolverLazyCallInvokesDelegateToResolve(): void
    {
     ...
     * @since  2026-04-18
     */
    public function testBucketResolverLazyCallReceivesContainer(): void
    {
        $container = $this->makeContainer();
        $received  = null;
     ...
     * @since  2026-04-18
     */
    public function testBucketResolverLazyCallResolveInvokesCallable(): void
    {
        $container = $this->makeContainer();
        $expected  = new stdClass();
        $lazy      = new Call(static function (object $c) use ($expected) {
