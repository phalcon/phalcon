...
final class FunctionCallTest extends AbstractUnitTestCase
{
     ...
     * @since  2026-04-18
     */
    public function testBucketResolverLazyFunctionCallInvokeDelegatesToResolve(): void
    {
     ...
     * @since  2026-04-18
     */
    public function testBucketResolverLazyFunctionCallResolveCallsFunction(): void
    {
        $container = $this->makeContainer();
     ...
     * @since  2026-04-18
     */
    public function testBucketResolverLazyFunctionCallResolveWithMultipleArguments(): void
    {
        $container = $this->makeContainer();
     ...
     * @since  2026-04-18
     */
    public function testBucketResolverLazyFunctionCallResolveWithNoArguments(): void
    {
        $container = $this->makeContainer();
