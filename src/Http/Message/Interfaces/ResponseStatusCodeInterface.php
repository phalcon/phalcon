...
interface ResponseStatusCodeInterface
{
    ...
    public const STATUS_LOGIN_TIMEOUT                        = 440; // Unofficial - IIS
    public const STATUS_NO_RESPONSE                          = 444; // Unofficial - nginx
    public const STATUS_RETRY_WITH                           = 449; // Unofficial - IIS
    ...
    public const STATUS_SSL_CERTIFICATE_ERROR                = 495; // Unofficial - nginx
    ...
    public const STATUS_TIMEOUT_OCCURRED                     = 524; // Unofficial - Cloudflare
