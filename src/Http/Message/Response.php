...
final class Response extends AbstractMessage implements ResponseInterface
{
    ...
    protected function getPhrases(): array
    {
        return [
            ...
            self::STATUS_THIS_IS_FINE                         => "This is fine",
            // Unofficial - Laravel Framework
            self::STATUS_PAGE_EXPIRED                         => "Page Expired",
            // Unofficial - Spring Framework
            self::STATUS_METHOD_FAILURE                       => "Method Failure",
            // Unofficial - IIS
            self::STATUS_LOGIN_TIMEOUT                        => "Login Time-out",
            // Unofficial - nginx
            self::STATUS_NO_RESPONSE                          => "No Response",
            // Unofficial - IIS
            self::STATUS_RETRY_WITH                           => "Retry With",
            // Unofficial - nginx
            self::STATUS_BLOCKED_BY_WINDOWS_PARENTAL_CONTROLS => "Blocked by Windows Parental Controls (Microsoft)",
            // Unofficial - nginx
            self::STATUS_REQUEST_HEADER_TOO_LARGE             => "Request header too large",
            // Unofficial - nginx
            self::STATUS_SSL_CERTIFICATE_ERROR                => "SSL Certificate Error",
            // Unofficial - nginx
            self::STATUS_SSL_CERTIFICATE_REQUIRED             => "SSL Certificate Required",
            // Unofficial - nginx
            self::STATUS_HTTP_REQUEST_SENT_TO_HTTPS_PORT      => "HTTP Request Sent to HTTPS Port",
            // Unofficial - ESRI
            self::STATUS_INVALID_TOKEN_ESRI                   => "Invalid Token (Esri)",
            // Unofficial - nginx
            ...
            // Unofficial - Cloudflare
            self::STATUS_WEB_SERVER_IS_DOWN                   => "Web Server Is Down",
            // Unofficial - Cloudflare
            self::STATUS_CONNECTION_TIMEOUT                   => "Connection Timed Out",
            // Unofficial - Cloudflare
            self::STATUS_ORIGIN_IS_UNREACHABLE                => "Origin Is Unreachable",
            // Unofficial - Cloudflare
            self::STATUS_TIMEOUT_OCCURRED                     => "A Timeout Occurred",
            // Unofficial - Cloudflare
            self::STATUS_SSL_HANDSHAKE_FAILED                 => "SSL Handshake Failed",
            // Unofficial - Cloudflare
            self::STATUS_INVALID_SSL_CERTIFICATE              => "Invalid SSL Certificate",
            // Unofficial - Cloudflare
            self::STATUS_RAILGUN_ERROR                        => "Railgun Error",
            // Unofficial - Cloudflare
            self::STATUS_ORIGIN_DNS_ERROR                     => "Origin DNS Error",
            // Unofficial
            self::STATUS_NETWORK_READ_TIMEOUT_ERROR           => "Network read timeout error",
            // Unofficial
