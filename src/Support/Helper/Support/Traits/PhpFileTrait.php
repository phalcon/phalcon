...
trait PhpFileTrait
{
     ...
     */
    protected function phpFeof($filename): bool
    {
     ...
     * @return string|false
     */
    protected function phpFread($stream, int $length)
    {
        return fread($stream, $length);
    }

    /**
     * Binary-safe file seek
     *
     * @param resource $stream
     * @param int      $offset
     * @param int      $whence
     ...
     * @return string|false
     */
    protected function phpFseek($stream, int $length)
    {
        return fseek($stream, $length);
    }
