...
final class ContainerResolver
{
     ...
     */
    public static function resolveFresh(mixed $container, string $name): object
    {
     ...
     * @throws ContainerException
     */
    private static function resolveShared(mixed $container, string $name): object
    {
        if ($container instanceof Collection) {
            /** @var object */
            return $container->get($name);
