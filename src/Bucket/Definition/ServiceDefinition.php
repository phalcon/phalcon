...
namespace Phalcon\Bucket\Definition;
...
class ServiceDefinition
{
    ...
    protected object|null $bucket    = null;
    ...
    public function addTag(string $tag): static
    {
        ...
        if ($this->bucket !== null && method_exists($this->bucket, 'registerTag')) {
            $this->bucket->registerTag($tag, $this->serviceName);
        }
    ...
    public function setBucket(object $bucket): static
    {
        $this->bucket = $bucket;
