 ...
 * @method object fetchObject(string $statement, array $values = [], string $class = "stdClass", array $arguments = [])
 * @method array  fetchObjects(string $statement, array $values = [], string $class = "stdClass", array $arguments = [])
