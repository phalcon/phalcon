...
/**
 * Phiz\Db and its related classes provide a simple SQL database interface
 * for Phalcon Framework. The Phiz\Db is the basic class you use to connect
 ...
 * Phiz\Mvc\Model.
 *
 * Phiz\Db\AbstractDb is an abstract class. You only can use it with a
 * database adapter like Phiz\Db\Adapter\Pdo
 *
 * php
 * use Phiz\Db;
 * use Phiz\Db\Exception;
 * use Phiz\Db\Adapter\Pdo\Mysql as MysqlConnection;
 *
 * try {
