...
interface AdapterInterface
{
     ...
     */
    public function delete(string $table, string $whereCondition = null, 
     ...
     */
    public function dropTable(string $tableName, ?string  $schemaName = null, 
            bool $ifExists = true) : bool;
     ...
     * return any rows
     */
    public function execute(string $sqlStatement, ?array $placeholders = null, ?array $dataTypes = null) : bool;

    /**
     * Dumps the complete result of a query into an array
     */
    public function fetchAll(string $sqlQuery, int $fetchMode = 2, 
            ?array $placeholders = null) : array;
     ...
     *```
     */
    public function fetchColumn(string $sqlQuery, ?array $placeholders = [], int $column = 0) : ?string;

    /**
     * Returns the first row in a SQL query result
     */
    public function fetchOne(string $sqlQuery, int $fetchMode = 2, 
        ?array $placeholders = null) : ?array;
     ...
     */
    public function modifyColumn(string $tableName, string $schemaName, 
            ColumnInterface $column, ColumnInterface $currentColumn = null) : bool;
     ...
     * rows
     */
    public function query(string $sqlStatement, ?array $placeholders = null, ?array $dataTypes = null) : ?ResultInterface;
