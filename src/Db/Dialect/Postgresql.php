...
class Postgresql extends Dialect
{
    ...
    public function createTable(string $tableName, string $schemaName, array $definition): string
    {
        ...
        for column in columns {
            ...
            */
            if $column->getComment() {
                $indexSqlAfterCreate .= " COMMENT ON COLUMN " . table . ".\"" . $column->getName()."\" IS '".$column->getComment()."';";
            }
        }
        ...
        if fetch references, definition["references"] {
            for reference in references {
                ...
                $referenceSql .= $this->prepareTable(
     ...
     * ```
     */
    public function describeColumns(string $table, string $schemaName = ""): string
    {
    ...
    public function modifyColumn(string $tableName, string $schemaName, ColumnInterface $column, <ColumnInterface> currentColumn = null): string
    {
         ...
         */
         if $column->getComment() {
            $sql .= "COMMENT ON COLUMN " . $this->prepareTable(tableName, schemaName) . ".\"" .$column->getName()."\" IS '" . $column->getComment() . "';";
        }
    ...
    public function truncateTable(string $tableName, string $schemaName): string
    {
        ...
        if schemaName {
            ...
            $table = $this->prepareTable(tableName);
        }
