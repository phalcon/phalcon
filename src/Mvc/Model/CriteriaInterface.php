...
interface CriteriaInterface
{
    ...
    public function andWhere(string $conditions, 
        $bindParams = null, $bindTypes = null) : CriteriaInterface;
     ...
     *```
     */
    public function innerJoin(string $model, 
        $conditions = null, $alias = null) : CriteriaInterface;
     ...
     * @param mixed maximum
     */
    public function notBetweenWhere(string $expr, 
        $minimum, $maximum) : CriteriaInterface;
